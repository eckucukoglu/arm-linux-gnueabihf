...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CONFIG_ARGS': "'--host=arm-linux-gnueabihf' '--build=x86-linux' '--prefix=/python' '--disable-ipv6' 'ac_cv_file__dev_ptc=no' 'ac_cv_file__dev_ptmx=no' 'build_alias=x86-linux' 'host_alias=arm-linux-gnueabihf' 'CC=arm-linux-gnueabihf-gcc'",
 ...
 'LN': 'ln',
 'LOCALMODLIBS': '-lreadline -ltermcap  -L/usr/local/ssl/lib -lssl -lcrypto  -L/python/lib -lz',
 'MACHDEP': 'linux2',
 ...
 'MKDIR_P': '/bin/mkdir -p',
 'MODLIBS': '-lreadline -ltermcap  -L/usr/local/ssl/lib -lssl -lcrypto  -L/python/lib -lz',
 ...
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/eckucukoglu/1511/Python-2.7.5 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /home/eckucukoglu/1511/Python-2.7.5/`cat pybuilddir.txt`:)./Lib:./Lib/plat-linux2 ./python_for_build',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'abs_builddir': '/home/eckucukoglu/1511/Python-2.7.5',
 'abs_srcdir': '/home/eckucukoglu/1511/Python-2.7.5',
